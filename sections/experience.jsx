  ...
  return (
    <Fragment>
      <section id="experience" ref={expeRef}>
        ...
        <div
          className="pop-down-child pb-[30px] px-[30px] shadow-sm shadow-zinc-300 dark:shadow-zinc-700"
          ref={expeBoxesRef}
        >
          {ExperienceData.map((experience, index) =>
            experience.side === 'left' ? (
              <div
                className={`bg-[] ml-24 rounded-lg
                   md:flex gap-2 items-end transition-all duration-500 ${
                     index !== 0 ? 'mt-7' : ''
                   }`}
                key={experience.companyName}
              >
                <div
                  className=" bg-[#f4eded] dark:bg-[#312f2f]  hover:bg-[#c7c6c6] dark:hover:bg-[#333333] hover:scale-105 rounded-lg md:w-[40%] cursor-pointer p-3 border border-zinc-300 dark:border-zinc-700 shadow-zinc-300 dark:shadow-zinc-700 shadow-sm"
                  onClick={() =>
                    setDesc(
              ...
              <div
                className="md:flex justify-end items-end mt-7 gap-2 transition-all duration-500 px-[30px]"
                key={experience.companyName}
              >
                <button
                ...
                <div
                  className="bg-[#f4eded] dark:bg-[#312f2f]  hover:bg-[#c7c6c6] dark:hover:bg-[#333333] hover:scale-105 rounded-lg md:w-[40%] cursor-pointer  transition-all duration-500 p-3 border border-zinc-300 dark:border-zinc-700 shadow-zinc-300 dark:shadow-zinc-700 shadow-smrounded"
                  onClick={() =>
                    setDesc(
                      desc === experience.description
                        ? ''
