        ...
        <div className="pb-[30px] px-[20px] md:px-[100px] lg:px-[200px] md:flex gap-[50px]">
          ...
          >
            ...
            <div className="mt-5 justify-evenly text-justify">
              ...
              I'm Leul Abera, a Software Engineer with a solid foundation in Full-Stack Web Development and Mobile Application Development, coupled with a growing interest in Artificial Intelligence. I graduated from Arba Minch University, where I honed my skills in building dynamic web and mobile applications. Recently, I have been expanding my knowledge in AI, particularly in exploring its potential for developing intelligent, data-driven solutions.
              </p>
            </div>
